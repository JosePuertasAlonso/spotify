...
public class Ver_todos_perfiles_buscados__administrador_ extends VistaVer_todos_perfiles_buscados_administrador {
	...
	public Ver_todos_perfiles_buscados__administrador_(VerticalLayout cuerpo) {
		...
		_lista_de_perfiles__ver_todo_administrador_ = new Lista_de_perfiles__ver_todo_administrador_(cuerpo);
