...
//	private Button _opcionesB;
	...
	public Reproducir_cancion_cibernauta_registrado(VerticalLayout cuerpo, HorizontalLayout minireproductor) {
		...
		this.getButton_opciones().addClickListener(new ComponentEventListener<ClickEvent<NativeButton>>() {
			...
			public void onComponentEvent(ClickEvent<NativeButton> event) {
				...
				_opciones_cancion__reproductor_ = new Opciones_cancion__reproductor_(cuerpo, minireproductor, popUp, GestorUsuarios._cancionReproduciendose);
