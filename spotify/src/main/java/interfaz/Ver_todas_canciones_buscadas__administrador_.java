...
public class Ver_todas_canciones_buscadas__administrador_ extends VistaVer_todas_canciones_buscadas_administrador {
	...
	public Ver_todas_canciones_buscadas__administrador_(VerticalLayout cuerpo) {
		...
		_lista_de_canciones__ver_todo_administrador_ = new Lista_de_canciones__ver_todo_administrador_(cuerpo);
