...
/**
 * A Designer generated component for the vista-eliminar_perfil template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-eliminar_perfil")
@JsModule("./src/vistas/vista-eliminar_perfil.ts")
public class VistaEliminar_perfil extends LitTemplate {
	...
	/**
     * Creates a new VistaEliminar_perfil.
     */
    public VistaEliminar_perfil() {
