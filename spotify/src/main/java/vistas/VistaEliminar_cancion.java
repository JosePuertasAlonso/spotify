...
/**
 * A Designer generated component for the vista-eliminar_cancion template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-eliminar_cancion")
@JsModule("./src/vistas/vista-eliminar_cancion.ts")
public class VistaEliminar_cancion extends LitTemplate {
	...
	/**
     * Creates a new VistaEliminar_cancion.
     */
    public VistaEliminar_cancion() {
