...
/**
 * A Designer generated component for the vista-eliminar_album template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("vista-eliminar_album")
@JsModule("./src/vistas/vista-eliminar_album.ts")
public class VistaEliminar_album extends LitTemplate {
	...
	/**
     * Creates a new VistaEliminar_album.
     */
    public VistaEliminar_album() {
