...
public class MDS12022PFCastellsTorresPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS12022PFCastellsTorres";
	...
	private MDS12022PFCastellsTorresPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS12022PFCastellsTorresPersistentManager();
		}
