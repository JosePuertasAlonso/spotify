...
<vaadin-vertical-layout style="background:#121212; max-width: 100%; max-height: 100%; align-items: flex-start; height: 100%;" class="fuentes " id="vL_fondo">
 <vaadin-vertical-layout theme="spacing" style="max-height: 90%; padding-top: var(--lumo-space-l); padding-right: var(--lumo-space-l); padding-left: var(--lumo-space-l); width: 100%; height: 100%;" id="vL_cuerpo">
  ...
  <vaadin-horizontal-layout theme="spacing" style="width: 100%; max-height: 65%; margin-left: 0px;" id="hL_cancionesAlbumesArtistasPerfiles">
   <vaadin-vertical-layout theme="spacing" style="overflow-y:scroll; width: 100%; margin-left: 0px; max-width: 33%;" id="vL_canciones">
   ...
   <vaadin-vertical-layout theme="spacing" style="overflow-y:scroll; width: 100%; max-width: 33%;" id="vL_albumes">
   ...
   <vaadin-vertical-layout theme="spacing-l" id="vL_artistasPerfiles" style="width: 100%; max-width: 33%;">
    <vaadin-vertical-layout theme="spacing" style="overflow-y:scroll; width: 100%; margin-top: 0px;" id="vL_artistas">
     ...
     <vaadin-horizontal-layout theme="spacing" style="width: 100%; max-height: 45%; height: 100%; margin-top: 0px;" id="hL_listaDeArtistasBuscadosAdmin"></vaadin-horizontal-layout>
    </vaadin-vertical-layout>
    <vaadin-vertical-layout theme="spacing" style="overflow-y:scroll; width: 100%;" id="vL_perfiles">
     ...
     <vaadin-horizontal-layout theme="spacing" style="width: 100%; max-height: 45%; height: 100%; margin-top: 0px;" id="hL_listaDePerfilesBuscadosAdmin"></vaadin-horizontal-layout>
    </vaadin-vertical-layout>
   </vaadin-vertical-layout>
  </vaadin-horizontal-layout>
 </vaadin-vertical-layout>
