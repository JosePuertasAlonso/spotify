...
@customElement('vista-eliminar_lista')
export class VistaEliminar_lista extends LitElement {
  static get styles() {
    return css`
      :host {
          display: block;
...
<vaadin-vertical-layout style="background-color:#121212; width: 100%; height: 100%; padding: var(--lumo-space-xl); align-items: center; border:none; border: 2px solid #A8A8A8; justify-content: center; margin-left: 0px; margin-right: 0px;" class="fuentes boton-rectangulo" theme="spacing" id="vL_fondo">
 <label style="flex-shrink: 0; align-self: center; text-align:center; margin-right: 0px; margin-left: 0px; margin-top: 0px;" id="label_eliminar">Eliminar lista de reproudcción</label>
