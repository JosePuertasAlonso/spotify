...
<vaadin-horizontal-layout class="content label-cancion" style="background-color:#181818; width: 100%; height: 100%; align-items: center; justify-content: space-between; max-width: 100%; max-height: 100%;" id="hL_fondo">
 ...
 <vaadin-horizontal-layout theme="spacing" style="height: 100%; justify-content: flex-end; align-items: center; margin-right: var(--lumo-space-m);" id="hL_botones">
  <button style="background:none; border:none; height: 100%; max-height: 65%; cursor: pointer;" id="button_eliminar">
