...
<vaadin-horizontal-layout class="content buscar" style="width: 100%; height: 100%; background-color:#121212" theme="spacing-l" id="hL_fondo">
 <vaadin-horizontal-layout theme="spacing-s" style="background-color: white; border-radius: 500px; width: 100%; height: 100%; padding-right: var(--lumo-space-m); padding-left: var(--lumo-space-m);" id="hL_iconoInput">
  ...
  <input type="text" placeholder="Canciones, artistas o listas de reproducción" style="width: 100%;" id="input_buscar">
