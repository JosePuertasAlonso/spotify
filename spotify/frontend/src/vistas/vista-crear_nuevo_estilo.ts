...
<vaadin-vertical-layout style="background:#121212; max-width: 100%; max-height: 100%; align-items: flex-start; height: 100%;" class="fuentes" id="vL_fondo">
 <vaadin-vertical-layout theme="spacing" style="max-height: 80%; padding-top: var(--lumo-space-l); padding-right: var(--lumo-space-l); padding-left: var(--lumo-space-l); height: 100%; width: 100%; max-width: 35%; align-self: center;" id="vL_cuerpo" class="botones-cabecera">
  ...
  <button style="color:#000000; background-color:#FFFFFF; max-height: 7%; max-width: 40%; margin-top: var(--lumo-space-l);" id="button_andirEstilo" class="registro">AÑADIR ESTILO</button>
