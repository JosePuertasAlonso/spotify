...
<vaadin-horizontal-layout class="content" style="background-color:#181818; width: 100%; height: 100%; align-items: center; justify-content: space-between; max-width: 100%; max-height: 100%;" id="hL_fondo">
 <vaadin-horizontal-layout theme="spacing" style="max-width: 50%; width: 100%; height: 100%; align-items: center;" id="hL_imagenArtista">
  <img style="max-height: 100%; max-width: 100%;" src="https://i.scdn.co/image/51488d1b1de7f592bcea6c66291dd274b95a9fc4" id="imagen">
