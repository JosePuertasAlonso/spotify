...
" id="imagen">
 ...
 <vaadin-horizontal-layout theme="spacing-s" style="align-self: center; width: 100%; height: 100%; align-items: center; max-width: 50%; justify-content: flex-end; margin-right: var(--lumo-space-l);" class="boton-rectangulo" id="hL_nCancionesAnadir">
