...
<vaadin-horizontal-layout class="content" style="background-color:#181818; width: 100%; height: 100%; align-items: center; justify-content: space-between; max-width: 100%; max-height: 100%;" id="hL_fondo">
 ...
 <button style="border:none; height: 2.3rem; width: 2.3rem; align-self: center; flex-grow: 0; cursor: pointer; background-color: #1ED760; border-radius: 50%; margin-right: var(--lumo-space-xl); padding: var(--lumo-space-s);" id="button_play" class="boton-play">
