...
<vaadin-horizontal-layout class="content" style="background-color:#181818; width: 100%; height: 100%; align-items: center; justify-content: space-between; max-width: 100%; max-height: 100%;" id="hL_fondo">
 <vaadin-horizontal-layout theme="spacing" style="max-width: 80%; width: 100%; height: 100%; align-items: center; margin: 0px;" id="hL_imagenTitulo">
 ...
 <button style="border:none; height: 2.3rem; width: 2.3rem; align-self: center; flex-grow: 0; cursor: pointer; background-color: #1ED760; border-radius: 50%; margin-right: var(--lumo-space-m); padding: var(--lumo-space-s); min-height: 2.3rem; min-width: 2.3rem; max-width: 2.3rem; max-height: 2.3rem;" id="button_play" class="boton-play">
