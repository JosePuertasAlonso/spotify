...
<vaadin-vertical-layout style="width: 100%; height: 100%; background-color:#121212;" class="fuentes botones-cabecera" theme="spacing" id="vL_fondo">
 <vaadin-horizontal-layout theme="spacing" id="hL_cabecera" style="width: 100%; max-height: 10%; margin: 0px;">
  <vista-cabecera style="width: 100%; height: 100%;" id="vistaCabecera"></vista-cabecera>
 ...
 <label style="flex-shrink: 0; align-self: center; font-weight: 300; max-width: 40%; text-align:center; margin-top: var(--lumo-space-xl); margin-bottom: var(--lumo-space-l);" id="label_instrucciones">Introduce la nueva contraseña para la cuenta de Spotify.</label>
 <label style="flex-shrink: 0; align-self: center; text-align:center; display: flex; align-items: center; background-color:#E91429; width: 100%; justify-content: center; min-width: 31%; max-width: 31%; padding-right: 10px; padding-left: 10px; margin-left: var(--lumo-space-l); padding-bottom: var(--lumo-space-xs); font-weight:400; font-size:1.1rem; padding-top: var(--lumo-space-xs);" id="label_errorContrasenaRequisitos">
 ...
 <button id="button_restablecerContrasena" class="registro" style="margin-top: var(--lumo-space-xl); max-width: 21%; color:#000000; background-color:#FFFFFF; max-height: 7%; max-width: 21%;">RESTABLECER CONTRASEÑA</button>
