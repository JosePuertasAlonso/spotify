...
@customElement('vista-lista_del_artista')
export class VistaLista_del_artista extends LitElement {
  static get styles() {
    return css`
      :host {
          display: block;
...
<vaadin-vertical-layout style="background-color:#181818; border-radius: 0.7rem; width: 100%; height: 100%; padding: var(--lumo-space-l); align-items: center;" class="label-lista" theme="spacing-l" id="vL_fondo">
 <img style="border-radius: 0.7rem; max-width: 100%; max-height: 90%;" src="https://i.scdn.co/image/ab67706f00000003af49c00b1dfe955e5b0ed73e" id="imagen">
 <vaadin-horizontal-layout theme="spacing" style="align-self: flex-start; width: 100%; flex-shrink: 0;" id="hL_tituloBoton">
  <vaadin-vertical-layout style="width: 100%; margin: 0px;" id="vL_tituloCreador">
   <label style="align-self: flex-start; color:#FFFFFF;" id="label_titulo">Los 90 España</label>
