...
<vaadin-vertical-layout style="width: 100%; height: 100%; background-color:#121212; overflow-y:scroll; margin-bottom: var(--lumo-space-l); overflow-y:scroll;" class="fuentes botones-cabecera" theme="spacing" id="vL_fondo">
 ...
 <vaadin-vertical-layout theme="spacing-l" class="botonlabel" style="max-width: 30%; width: 100%; align-items: center; align-self: center; margin-top: 0px;" id="vL_imagen">
  <img style="max-width: 40%; border-radius:50%; border: 2px solid #FFFFFF;" id="imagen">
  <span class="input_file" id="span"><input type="file" name="input_file" id="input_file" style="display:none" accept="image/*"></span>
  <label for="input_file" id="labelinput_file" style="color:#121212; background-color:#FFFFFF; border-radius:500px; display: flex; align-items: center; cursor:pointer; padding: 8px 34px; letter-spacing: 1.76px; padding-top: 12px; padding-bottom: 12px; justify-content: center; width: 100%; max-width: 35%; margin-top: var(--lumo-space-xs);">
