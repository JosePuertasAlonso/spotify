...
<vaadin-vertical-layout style="width: 100%; height: 100%; background-color:#121212; overflow-y:scroll;" class="fuentes botones-cabecera" theme="spacing" id="vL_fondo">
 ...
 <vaadin-vertical-layout theme="spacing-l" class="botonlabel" style="max-width: 30%; width: 100%; align-items: center; align-self: center; margin-top: var(--lumo-space-m);" id="vL_fotoBoton">
 ...
 <button style="color:#000000; background-color:#FFFFFF; max-height: 7%; max-width: 16%;" id="button_modificarArtista" class="registro">MODIFICAR ARTISTA</button>
</vaadin-vertical-layout>
`;
  }
