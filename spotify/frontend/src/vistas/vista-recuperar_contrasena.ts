...
<vaadin-vertical-layout style="width: 100%; height: 100%; background-color:#121212;" class="fuentes inicio-boton" theme="spacing" id="vL_fondo">
 ...
 <label style="flex-shrink: 0; align-self: center; font-weight: 300; font-size:; max-width: 40%; text-align:center; margin-top: var(--lumo-space-xl); margin-bottom: var(--lumo-space-xl);" id="label_instrucciones">Introduce el email que usaste para registrarte. Te enviaremos un correo electrónico con un enlace para restablecer la contraseña.</label>
 ...
 <button id="button_enviarCorreo" class="registro" style="margin-top: var(--lumo-space-xl);">ENVIAR CORREO</button>
