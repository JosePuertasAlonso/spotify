...
export class VistaAlbum_bloques extends LitElement {
  ...
  render() {
    return html`
<vaadin-vertical-layout style="background-color:#181818; border-radius: 0.7rem; width: 100%; height: 100%; padding: var(--lumo-space-l); align-items: center;" class="label-album" theme="spacing-l" id="vL_fondo">
 ...
 <vaadin-horizontal-layout theme="spacing" style="align-self: flex-start; width: 100%; flex-shrink: 0;" id="hL_tituloPlay">
  <vaadin-vertical-layout style="width: 100%;" id="vL_tituloArtista">
