...
" id="imagen">
 ...
 <vaadin-horizontal-layout theme="spacing-l" style="width: 100%; height: 100%; justify-content: flex-end; align-items: center; margin-right: var(--lumo-space-xl);" id="hL_botones">
  <button style="background:none; border:none; height: 100%; max-height: 55%; cursor: pointer;" id="button_guardar">
