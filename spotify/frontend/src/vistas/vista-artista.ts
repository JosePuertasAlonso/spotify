...
export class VistaArtista extends LitElement {
  ...
  render() {
    return html`
<vaadin-vertical-layout style="background-color:#181818; border-radius: 0.7rem; width: 100%; height: 100%; padding: var(--lumo-space-l); align-items: center;" class="label-artista" theme="spacing" id="vL_fondo">
