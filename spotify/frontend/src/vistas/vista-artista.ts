...
<vaadin-vertical-layout style="background-color:#181818; border-radius: 0.7rem; width: 100%; height: 100%; padding: var(--lumo-space-l); align-items: center;" class="label-lista" theme="spacing" id="vL_fondo">
 <button style="border-radius: 0.7rem; max-width: 100%; max-height: 90%; padding: 0px; border:none; background:none; cursor:pointer; border-radius:50%" id="button_imagen"><img style="border-radius: 0.7rem; max-width: 100%; max-height: 100%; border-radius:50%" id="imagen"></button>
