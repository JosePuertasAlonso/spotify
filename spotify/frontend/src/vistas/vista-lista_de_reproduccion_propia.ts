...
export class VistaLista_de_reproduccion_propia extends LitElement {
  ...
  render() {
    return html`
<vaadin-horizontal-layout class="content label-lista" style="background-color:#181818; width: 100%; height: 100%; align-items: center; justify-content: space-between; max-width: 100%; max-height: 100%;" id="hL_fondo">
 <vaadin-horizontal-layout theme="spacing" style="max-width: 50%; width: 100%; height: 100%; align-items: center; margin: 0px;" id="hL_imagenTitulo">
  <img style="max-height: 100%; max-width: 100%; margin: 0px;" id="imagen">
  <vaadin-vertical-layout style="align-self: center; width: 100%; height: 100%; align-items: center; justify-content: center; flex-direction: column; display: flex; align-items: center;" id="vL_tituloCreador">
 ...
 <vaadin-horizontal-layout theme="spacing" style="width: 100%; height: 100%; justify-content: flex-end; align-items: center; margin-right: var(--lumo-space-xl);" id="hL_botones">
  ...
  <button style="border:none; height: 2.3rem; width: 2.3rem; align-self: center; flex-grow: 0; cursor: pointer; background-color: #1ED760; border-radius: 50%; min-height: 2.3rem; min-width: 2.3rem; max-width: 2.3rem; max-height: 2.3rem; padding: var(--lumo-space-s);" id="button_play">
   <svg role="img" height="" width="" viewbox="0 0 24 24" class="Svg-sc-1bi12j5-0 hDgDGI" style="width: 100%; height: 100%; max-width: 100%; max-height: 100%; min-width: 100%; min-height: 100%; text-align;center; display: flex; align-items: center;">
    <path d="M7.05 3.606l13.49 7.788a.7.7 0 010 1.212L7.05 20.394A.7.7 0 016 19.788V4.212a.7.7 0 011.05-.606z" style="width: 100%; height: 100%;"></path>
   </svg></button>
 </vaadin-horizontal-layout>
</vaadin-horizontal-layout>
`;
