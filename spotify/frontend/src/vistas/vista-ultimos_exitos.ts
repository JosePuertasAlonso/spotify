...
::-webkit-scrollbar-thumb {
  ...
  render() {
    return html`
<vaadin-vertical-layout style="background-color:#121212; align-items: flex-start; max-height: 100%; width: 100%; height: auto; overflow-y:scroll;" theme="spacing" id="vL_fondo">
 ...
 <vaadin-vertical-layout theme="spacing" style="flex-shrink: 0; flex-grow: 0; max-height: 95%; " id="vL_filasCanciones">
  <vaadin-horizontal-layout theme="spacing" style="align-items: center; flex-shrink: 0; flex-direction: row; max-height: 50%; max-width: 100%;" id="hL_contenedorCanciones">
   <vista-cancion id="2"></vista-cancion>
   <vista-cancion id="1"></vista-cancion>
  ...
  <vaadin-horizontal-layout theme="spacing" style="max-height: 50%;" id="hL_contenedorCanciones1">
   ...
   <vista-cancion id="vistaCancion6"></vista-cancion>
   <vista-cancion id="vistaCancion7"></vista-cancion>
  </vaadin-horizontal-layout>
